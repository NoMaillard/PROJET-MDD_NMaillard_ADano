...
\begin{alltt}
	\input{/Users/Noe/Documents/Cours/S2/MDD/Document_de_conception/Description_des_fonctions/Menu.txt}
\end{alltt}
...
\hline
\textsc{\textbf{fonctions}} & codées & testées & commentaires \\
\hline
	Main.\textbf{init()} & Oui & Oui & 18/04 \\
\hline
	Main.\textbf{run()} & Oui & Oui & 18/04\\
\hline
	Main.\textbf{show()} & Oui & Oui & 18/04 \\
\hline
	Main.\textbf{interact()} & Oui & Oui & 18/04\\
\hline
    Main.\textbf{quit()} & Oui & Non & 18/04\\
\hline
    Game.\textbf{create()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{getMenu()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{getLevel()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{setLevel()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{getState()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{getWin()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{getName()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{setName()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{askName()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{getDifficulty()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{setDifficulty()} & Oui & Oui & 18/04\\
\hline
    Game.\textbf{askDifficulty()} & Oui & Oui & 18/04\\
\hline
    Menu.\textbf{create()} & Oui & Oui & 18/04\\
\hline
    Menu.\textbf{show()} & Oui & Oui & 18/04\\
\hline
    Menu.\textbf{interact()} & Oui & Oui & 18/04\\
\hline
    Menu.\textbf{getNumberOfMenuItems()} & Oui & Oui & 18/04\\
\hline
    Menu.\textbf{quit()} & Oui & Non & 18/04\\
\hline
    Level.\textbf{create()} & Oui & Oui & 18/04\\
\hline
    Level.\textbf{getLevelNumber()} & Oui & Oui & 18/04\\
\hline
    Level.\textbf{setLevelNumber()} & Oui & Oui & 18/04\\
\hline
    Level.\textbf{askLevelNumber()} & Oui & Oui & 18/04\\
\hline
    Level.\textbf{getNumberOfLevels()} & Oui & Oui & 18/04\\
\hline
\end{tabular}
}
